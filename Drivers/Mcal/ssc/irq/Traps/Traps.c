...
void _trap_4(void) {
  ...
  case 6:
    /*Compiler switch is used to Disable/Ignore Data Memory Integrity Error
     * Trap, when a test case executed intentionally to read data from Flash
     * location which has no data in it*/
